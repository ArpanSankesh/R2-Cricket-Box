...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-black text-white text-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-6">
              <a href="tel:+918982836220" className="flex items-start gap-4 p-6 rounded-3xl bg-zinc-900/50 border border-zinc-800 hover:border-green-500 transition group">
          ...
          <div className="bg-zinc-900/30 p-8 rounded-[40px] border border-zinc-800">
